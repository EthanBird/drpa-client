...
1. 干净系统无需安装 WebKitGTK、Python、Node、Rust 或 Chrome 即可启动并运行 RPAZ；现代包要求系统 glibc 2.35+ 与 C/C++ 运行库，UOS 包只要求系统 glibc 2.28 并使用私有 glibc/C++ 层；两者的 EGL/GL/GBM 仍由系统提供。
